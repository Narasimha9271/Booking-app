...
// bcrypt is often used for password hashing and encryption
// When a user registers or changes their password, you'll hash the password using bcrypt before storing it in your database.
